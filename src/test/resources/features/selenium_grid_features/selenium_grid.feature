...
#  java -Dwebdriver.chrome.driver="Users\guler\Documents\selenium dependencies\drivers\chromedriver.exe" -jar selenium-server-standalone-3.141.59.jar -role node -hub http://192.168.0.27:4444/grid/register/ -port 4445
#
#  CHANGE 3 DATA:
#  chrome        -> gecko
...
#  java -Dwebdriver.gecko.driver="/Users\guler\Documents\selenium dependencies\drivers\chromedriver.exe" -jar selenium-server-standalone-3.141.59.jar -role node -hub http://192.168.0.27:4444/grid/register/ -port 4446
  @grid_firefox
...
#  java -Dwebdriver.chrome.driver="/Users/techproed/Documents/selenium libraries/drivers/chromedriver" -jar selenium-server-standalone-3.141.59.jar -role node -hub http://192.168.1.34:4444/grid/register -port 4445

#  3. Register node for firefox:
#  -Change Directory and run code:
#  java -Dwebdriver.gecko.driver="/Users/techproed/Documents/selenium libraries/drivers/geckodriver" -jar selenium-server-standalone-3.141.59.jar -role node -hub http://192.168.1.34:4444/grid/register -port 4446
...
#  ####################### ################### ################# verify the title includes Resortsline